...
class CreateTransportsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('transports', function (Blueprint $table) {
            ...
            $table->string('voucher_number')->comment('Số chứng từ')->nullable();
            $table->string('quantum_product_on_voucher')->comment('Số lượng sản phẩm trên chứng từ')->default(0);
            $table->string('receiver')->comment('Người nhận')->nullable();
            ...
            $table->integer('fuel_id')->unsigned()->comment('Mã Dầu/Nhớt nếu trong công thức có giá Dầu/Nhớt');
            $table->timestamps();
        });
    }
