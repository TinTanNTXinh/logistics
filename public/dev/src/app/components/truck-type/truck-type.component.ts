...
export class TruckTypeComponent implements OnInit
    ...
    ngOnInit(): void {
        ...
        this.header = {
            ...
            fc_unit_price_park: {
                title: 'Đơn giá đậu bãi',
                data_type: 'NUMBER',
                prop_name: 'unit_price_park'
            },
            description: {
                title: 'Mô tả',
                data_type: 'TEXT'
    ...
    loadOne(id: number): void {
        this.truck_type = this.truck_types.find(o => o.id == id);
    }
    ...
    addOne(): void {
        ...
        this.httpClientService.post(this.prefix_url, {"truck_type": this.truck_type}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
    ...
    updateOne(): void {
        ...
        this.httpClientService.put(this.prefix_url, {"truck_type": this.truck_type}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
