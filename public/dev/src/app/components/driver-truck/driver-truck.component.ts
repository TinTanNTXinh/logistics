...
@Component({
    ...
    templateUrl: './driver-truck.component.html',
    styles: []
})
export class DriverTruckComponent implements OnInit
    ...
    /** ===== MY VARIABLES ===== **/
    public driver_trucks: any[] = [];
    public driver_truck: any;
    public drivers: any[] = [];
    public trucks: any[] = [];
    ...
    loadOne(id: number): void {
        this.driver_truck = this.driver_trucks.find(o => o.id == id);
        console.log(id);
        console.log(this.driver_truck)
    }
    ...
    addOne(): void {
        ...
        this.httpClientService.post(this.prefix_url, {"driver_truck": this.driver_truck}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
    ...
    updateOne(): void {
        ...
        this.httpClientService.put(this.prefix_url, {"driver_truck": this.driver_truck}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
    ...
    validateOne(): boolean {
        ...
        if (this.driver_truck.driver_id == 0) {
            flag = false;
            this.toastrHelperService.showToastr('warning', `Tài xế không được để trống!`);
        }
        if (this.driver_truck.truck_id == 0) {
            flag = false;
    ...
    reloadDataSearch(arr_data: any[]): void {
        this.driver_trucks = arr_data['driver_trucks'];
    }
