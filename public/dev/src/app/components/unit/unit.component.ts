...
export class UnitComponent implements OnInit
    ...
    loadOne(id: number): void {
        let unit = this.units.find(o => o.id == id);
    ...
    addOne(): void {
        ...
        this.httpClientService.post(this.prefix_url, {"unit": this.oneFormGroup.value}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
    ...
    updateOne(): void {
        ...
        this.httpClientService.put(this.prefix_url, {"unit": this.oneFormGroup.value}).subscribe(
            (success: any) => {
                this.reloadData(success);
                this.clearOne();
