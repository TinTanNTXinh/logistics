...
class FormulaSampleService implements FormulaSampleServiceInterface
{
    ...
    protected $authService, $formulaSampleRepo;
    ...
    {
        $all = $this->formulaSampleRepo->findAllActiveSkeleton();
    ...
    {
        $one = $this->formulaSampleRepo->findOneActiveSkeleton($id);
    ...
    public function createOne($data)
    {
        ...
        try {
            ...
            $one = $this->formulaSampleRepo->createOne($i_one);
    ...
    public function updateOne($data)
    {
        ...
        try {
            ...
            $one = $this->formulaSampleRepo->findOneActive($data['id']);
            ...
            $one = $this->formulaSampleRepo->updateOne($one->id, $i_one);
    ...
    public function deactivateOne($id)
    {
        ...
        try {
            ...
            $one = $this->formulaSampleRepo->deactivateOne($id);
    ...
    public function deleteOne($id)
    {
        ...
        try {
            ...
            $one = $this->formulaSampleRepo->destroyOne($id);
    ...
    public function searchOne($filter)
    {
        ...
        $filtered = $this->formulaSampleRepo->findAllActiveSkeleton();
        ...
        return [
            'formula_samples' => $filtered->values()
        ];
    }
