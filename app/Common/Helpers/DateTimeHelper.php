...
class DateTimeHelper
{
    ...
    static public $clientFormatDate = 'd/m/Y';
    static public $clientFormatTime = 'H:i:s';
    static public $clientFormatDateTime = 'd/m/Y H:i:s';
    ...
    static public function compareDateTime($d1, $fd1, $d2, $fd2)
    {
        ...
        if ($a->diffInMinutes($b, false) == 0)
            ...
            return 1; // a < b (a before b)
        else
            return -1; // a > b (a after b)
    }
}