...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'driver-truck'     => \App\Http\Middleware\DriverTruck::class,
        ...
        'invoice-truck'    => \App\Http\Middleware\InvoiceTruck::class,
        ...
        'voucher'          => \App\Http\Middleware\Voucher::class,
        'formula-sample'   => \App\Http\Middleware\FormulaSample::class,
        'truck-type'       => \App\Http\Middleware\TruckType::class,
    ];
}
