...
class VoucherController extends Controller implements ICrud
{
    private $table_name;
    ...
    {
        return $this->voucherService->createOne($data);
    }

    public function updateOne($data)
    {
        return $this->voucherService->updateOne($data);
    }

    public function deactivateOne($id)
    {
        return $this->voucherService->deactivateOne($id);
    }
    ...
    {
        return $this->voucherService->searchOne($filter);
    }
